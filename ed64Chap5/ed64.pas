...
* (c) 2006 by ir. Marc Dendooven                                 *
* Version : Chapter 5                                            *
*****************************************************************)
program ED64;

uses memio, crt, SysUtils, DateUtils;
                ...
                begin   ch := ord(upcase(readkey));
                        if ch = 0 then
                           begin
                                ...
                                133 : begin
                                        writeln;
                                        write('EMULATOR LOAD. FILENAME: ');
                                        readln (filename);
                                        load_prg (filename+'.prg',true)
                                      end;
                                135 : begin
                                        writeln;
                                        write('EMULATOR LOAD,x,1. FILENAME: ');
                                        readln (filename);
                                        load_prg (filename+'.prg',false)
                                      end;
                                134 : begin
                                        writeln;
                                        write('EMULATOR SAVE. FILENAME: ');
                                        readln (filename);
